...
using these elementary modes and kinetic parameters reported by Kim et al. \cite{2008_kim_varner_ramkrishna_BiotechProg} (Fig. \ref{fig:ecoli}A, dashed).
We estimated the HCM FBA model parameters from the experimental data set taken from Kim et al.  \cite{2008_kim_varner_ramkrishna_BiotechProg} using simulated annealing.
