...
Metabolic networks, even for simple organisms such as \textit{E. coli}, contain thousands of intracellular metabolites and reactions that are highly interconnected.
Constraints based models and convex analysis techniques have become the standard approaches to interrogate these complex networks.
